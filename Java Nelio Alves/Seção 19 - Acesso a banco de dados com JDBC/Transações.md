...
4. #Durabilidade: uma vez que uma transação é confirmada (committed), <span style="background:#b1ffff">suas alterações nos dados devem ser permanente</span>s, mesmo em caso de falha do sistema. 
