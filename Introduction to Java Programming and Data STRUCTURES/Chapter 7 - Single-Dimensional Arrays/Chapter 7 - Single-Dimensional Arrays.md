...
Searching is the process of looking for a specific element in an array, for example, discovering whether a certain score is included in a list of scores. Searching is a common task in computer programming. Many algorithms and data structures are devoted to searching. Many algorithms and data structures are devoted to searching. This section discusses two commonly used approaches, *linear search* and *binary search*.
...
The better understand this method, trace it with the following statements:
1. int[] list = {1, 4, 4, 2, -3, 6, 2 };
